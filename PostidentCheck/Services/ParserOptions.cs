...
namespace PostidentCheck.Services
{
    public class ParserOptions
    {
        ...
        [Option('c', "Carrier", Required = false, HelpText = "Checks data only for selected carrier names, separated by coma: '--Carrier DPD' or '--Carrier DPD DHL. Possible options: DHL, DHL_Sperr, DPD, DPD_PL, HES, Schenker, Schenker_PL, Pick_up, Self_delivery", Separator = ',')]
