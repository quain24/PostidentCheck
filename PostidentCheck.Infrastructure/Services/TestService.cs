...
namespace Postident.Infrastructure.Services
{
    public class TestService
    {
        public async Task test()
        {
            ...
            //              "         <cis:signature>!FuckFCB1900!</cis:signature>\r\n      </cis:Authentification>\r\n   </soapenv:Header>\r\n" +
        ...
        public async Task testNew()
        {
            ...
            t.ValidationState.ToList().ForEach(v => Console.WriteLine(string.Join(", ", v.Status.statusMessage) + "\n" + v.Status.statusText));
